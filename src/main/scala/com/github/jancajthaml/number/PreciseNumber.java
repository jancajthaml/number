...
class PreciseNumber implements Cloneable 
{
  ...
  public boolean equals(Object o)
  {
    ...
    try               { return 0 == compare(this, (PreciseNumber)o, nw);  }
  ...
  static void zero(PreciseNumber in)
  {
    in.number_words   = 0;
    in.sign       = true;
    in.exponent     = 0;
  ...
  static void log (PreciseNumber a, PreciseNumber al2, PreciseNumber b, int lnw)
  {
    ...
    {
      b.number_words = 0; b.exponent=0; b.sign=true;
      return;
    }
  ...
  static void _cosh (PreciseNumber a, PreciseNumber pi, PreciseNumber al2, PreciseNumber x, PreciseNumber y, int lnw)
  {
  ...
  static int outx (PreciseNumber a, char b[], int lnw)
  {
    ...
    else if (nb1 < i1) for(i = nb1; i< i1; i++) b[i] = '0';
